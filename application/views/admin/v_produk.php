			...
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						...
						<span>Berikut daftar galeri produk.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?= site_url('admin/kategori') ?>">Kategori Produk</a>
                        </li>
						<li class="breadcrumb-item">
							<a href="<?= site_url('admin/produk') ?>">Galeri Produk</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="page-body">
					<div class="card">
						<div class="card-header">
							<h5>Data Galeri Produk</h5>
                            <div class="card-header-right"> <ul class="list-unstyled card-option"> <li class="first-opt"><i class="feather icon-chevron-left open-card-option"></i></li> <li><i class="feather icon-maximize full-card"></i></li> <li><i class="feather icon-minus minimize-card"></i></li> <li><i class="feather icon-refresh-cw reload-card"></i></li> <li><i class="feather icon-trash close-card"></i></li> <li><i class="feather icon-chevron-left open-card-option"></i></li> </ul> </div>
						</div>
						<div style="position: absolute;right: 20px; top: 15px;">
                            <a class="btn btn-primary btn-round" href="<?= site_url('admin/produk/tambah')  ?>"><span class="fa fa-edit"></span> Input Data</a>    
                        </div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/produk/json/<?= $kat ?>", "type": "POST"},
        columns: [
        {
            "data": "id_produk",
            "orderable": false
        ...
        {"data": "gambar","orderable": false,
            render: function(data) { 
                if(data!==null) {
                  ...
                  return '<img class="img-thumbnail" width="100%" height="100" src="<?= base_url('assets/assets/img/produk/') ?>'+data+'">' 
                } else {
