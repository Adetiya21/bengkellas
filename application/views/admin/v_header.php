			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('admin/header') ?>">Header Website</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/header/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
        ...
        {"data": "gambar","orderable": false,
            render: function(data) { 
                if(data!==null) {
                  ...
                  return '<img class="img-thumbnail" width="100%" height="100" src="<?= base_url('assets/assets/img/header/') ?>'+data+'">' 
                } else {
                    return '<i>(Tidak ada gambar)</i>'
                }},
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("admin/header/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function tambah()
    {
        ...
        $('.modal-title').text('Tambah Header Website'); // Set Title to Bootstrap modal title
    }
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('admin/header/tambah')?>";
        } else {
            url = "<?php echo site_url('admin/header/update')?>";
        }
