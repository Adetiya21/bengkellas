			...
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						...
						<span>Berikut data kategori produk.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				...
				<div class="page-body">
					<div class="card">
						...
						<div style="position: absolute;right: 20px; top: 15px;">
                            <a href="<?= site_url('admin/kategori/tambah') ?>" class="btn btn-primary btn-round"><span class="fa fa-edit"></span> Input Data</a>   
        ...
        {"data": "gambar","orderable": false,
            render: function(data) { 
                if(data!==null) {
                  ...
                  return '<img class="img-thumbnail" width="100%" height="100" src="<?= base_url('assets/assets/img/kategori/') ?>'+data+'">' 
                } else {
