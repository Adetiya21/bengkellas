    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-6 col-md-5 modal-bg-img" style="background-image: url(<?= base_url('assets/')?>assets/images/big/logobengkel.jpg);">
                </div>
                <div class="col-lg-6 col-md-7 bg-white">
                    <div class="p-3">
                        <div class="text-center">
                            <img src="<?= base_url('assets/')?>assets/images/big/icon.png" alt="wrapkit" style="max-width: 30px;">
                        </div>
                        <h2 class="mt-3 text-center">LOGIN ADMIN</h2>
                        <p class="text-center">Login untuk memanagemen seluruh data website Bengkel Las Pontianak</p>
